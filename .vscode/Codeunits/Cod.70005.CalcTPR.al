codeunit 70005 "Calculate TPR"
{
    ...
    procedure CalcMTD(pType: Text; pStartDate: Date; pEndDate: Date; pItem: Record Item; pSpecialGrp: Record "LSC Item/Special Group Link")
    begin
    ...
    begin
        ...
        if (TPR."Opening Inv Actual Retail" <> 0) then
            TPR."Opening Inv Ratio" := TPR."Opening Inv Actual Cost" / TPR."Opening Inv Actual Retail";
    end;
    ...
    begin
        ...
        if (pType = 'Stock Loss') then begin
            ...
            if TPR."Stock Loss Actual Retail" <> 0 then
                TPR."Stock Loss Ratio" := TPR."Stock Loss Actual Cost" / TPR."Stock Loss Actual Retail";
            //StockLoss+
        end;
        ...
        TPR."Ending Inv Actual Retail" := TPR."Opening Inv Actual Retail" + TPR."Net Purchase Actual Retail" - TPR."Sales Amount";
        if (TPR."Ending Inv Actual Retail" <> 0) then
            TPR."Ending Inv Ratio" := TPR."Ending Inv Actual Cost" / TPR."Ending Inv Actual Retail";
        //endingInventory+
        #endregion
    end;
